...
const translations: Record<LanguageCode, Record<string, string>> = {
  ca: {
    ...
    bmwTitle: "Per què això pot interessar fins i tot a la comunitat BMW",
  ...
  es: {
    ...
    bmwTitle: "Por qué esto puede interesar incluso a la comunidad BMW",
  ...
  fr: {
    ...
    bmwTitle: "Pourquoi cela peut intéresser même la communauté BMW",
  ...
  en: {
    ...
    bmwTitle: "Why this could interest even the BMW community",
  ...
  pt: {
    ...
    roadmapTitle: "Roadmap recomendado",
    bmwTitle: "Porque isto pode interessar até à comunidade BMW",
  ...
  de: {
    ...
    bmwTitle: "Warum das sogar für die BMW-Community interessant sein kann",
  ...
  ru: {
    ...
    bmwTitle: "Почему это может заинтересовать даже сообщество BMW",
