...
const translations: Record<LanguageCode, Record<string, string>> = {
  ca: { eyebrow: "Calendari públic del club", title: "Sortides, esdeveniments i temporada viva", subtitle: "El calendari públic del club reuneix les temporades visibles, els anys recuperats i la meteo comparada d'origen i destí per a cada sortida.", open2026: "Obrir 2026", weather: "Meteo origen / destí", recovered: "esdeveniments recuperats", pending: "pendents a partir d'avui", viewCalendar: "Veure calendari", coverageTitle: "Cobertura actual", coverageBody: "Inclou", coverageBody2: "sortides i activitats públiques a partir del calendari original, els títols recuperats del recull del club i les dates inferides de les fotos quan el calendari antic retornava error.", coverageNote: "Les dates confirmades per la web original conserven enllaç a l'original. Les dates inferides queden marcades per evitar confusions.", seasons: "temporades visibles", spotlight: "Ruta destacada", spotlightBody: "L'experiència de calendari combina agenda, detall de ruta, meteo i connexió directa amb galeria i arxiu.", openHighlights: "Obrir destacats", yearsLabel: "Anys recuperats" },
  es: { eyebrow: "Calendario público del club", title: "Salidas, eventos y temporada viva", subtitle: "El calendario público del club reúne las temporadas visibles, los años recuperados y la meteo comparada de origen y destino para cada salida.", open2026: "Abrir 2026", weather: "Meteo origen / destino", recovered: "eventos recuperados", pending: "pendientes a partir de hoy", viewCalendar: "Ver calendario", coverageTitle: "Cobertura actual", coverageBody: "Incluye", coverageBody2: "salidas y actividades públicas a partir del calendario original, los títulos recuperados del archivo del club y las fechas inferidas de las fotos cuando el calendario antiguo devolvía error.", coverageNote: "Las fechas confirmadas por la web original conservan enlace a la fuente. Las fechas inferidas quedan marcadas para evitar confusiones.", seasons: "temporadas visibles", spotlight: "Ruta destacada", spotlightBody: "La experiencia de calendario combina agenda, detalle de ruta, meteo y conexión directa con galería y archivo.", openHighlights: "Abrir destacados", yearsLabel: "Años recuperados" },
  fr: { eyebrow: "Calendrier public du club", title: "Sorties, événements et saison vivante", subtitle: "Le calendrier public du club réunit les saisons visibles, les années récupérées et la météo comparée entre origine et destination pour chaque sortie.", open2026: "Ouvrir 2026", weather: "Météo origine / destination", recovered: "événements récupérés", pending: "à venir à partir d'aujourd'hui", viewCalendar: "Voir le calendrier", coverageTitle: "Couverture actuelle", coverageBody: "Inclut", coverageBody2: "sorties et activités publiques à partir du calendrier original, des titres récupérés des archives du club et des dates déduites des photos lorsque l'ancien calendrier renvoyait une erreur.", coverageNote: "Les dates confirmées par le site original conservent un lien vers la source. Les dates déduites restent signalées pour éviter toute confusion.", seasons: "saisons visibles", spotlight: "Parcours mis en avant", spotlightBody: "L'expérience calendrier combine agenda, détail de parcours, météo et lien direct avec galerie et archives.", openHighlights: "Ouvrir les temps forts", yearsLabel: "Années reconstruites" },
  en: { eyebrow: "Public club calendar", title: "Outings, events and a live season", subtitle: "The club's public calendar brings together visible seasons, recovered years and origin/destination weather comparisons for each outing.", open2026: "Open 2026", weather: "Origin / destination weather", recovered: "recovered events", pending: "upcoming from today", viewCalendar: "View calendar", coverageTitle: "Current coverage", coverageBody: "It includes", coverageBody2: "public outings and activities from the original calendar, titles recovered from the club archive and dates inferred from photos when the old calendar returned an error.", coverageNote: "Dates confirmed by the original website keep a link to the source. Inferred dates remain marked to avoid confusion.", seasons: "visible seasons", spotlight: "Featured route", spotlightBody: "The calendar experience combines agenda, route detail, weather and direct links to gallery and archive.", openHighlights: "Open highlights", yearsLabel: "Recovered years" },
  pt: { eyebrow: "Calendário público do clube", title: "Passeios, eventos e temporada viva", subtitle: "O calendário público do clube reúne as temporadas visíveis, os anos recuperados e a meteorologia comparada de origem e destino para cada passeio.", open2026: "Abrir 2026", weather: "Meteorologia origem / destino", recovered: "eventos recuperados", pending: "pendentes a partir de hoje", viewCalendar: "Ver calendário", coverageTitle: "Cobertura atual", coverageBody: "Inclui", coverageBody2: "passeios e atividades públicas a partir do calendário original, dos títulos recuperados do arquivo do clube e das datas inferidas das fotos quando o calendário antigo devolvia erro.", coverageNote: "As datas confirmadas pelo site original mantêm link para a fonte. As datas inferidas permanecem assinaladas para evitar evitar confusões.", seasons: "temporadas visíveis", spotlight: "Rota em destaque", spotlightBody: "A experiência de calendário combina agenda, detalhe de rota, meteorologia e ligação direta à galeria e arquivo.", openHighlights: "Abrir destaques", yearsLabel: "Anos recuperados" },
  de: { eyebrow: "Öffentlicher Club-Kalender", title: "Ausfahrten, Veranstaltungen und eine lebendige Saison", subtitle: "Der öffentliche Kalender des Clubs vereint sichtbare Saisons, rekonstruierte Jahre und den Wettervergleich von Start und Ziel für jede Ausfahrt.", open2026: "2026 öffnen", weather: "Wetter Start / Ziel", recovered: "rekonstruierte Termine", pending: "noch ausstehend ab heute", viewCalendar: "Kalender ansehen", coverageTitle: "Aktuelle Abdeckung", coverageBody: "Enthält", coverageBody2: "öffentliche Ausfahrten und Aktivitäten aus dem Originalkalender, archivierte Clubtitel und aus Fotos abgeleitete Daten, wenn der alte Kalender Fehler lieferte.", coverageNote: "Vom Original bestätigte Daten behalten einen Link zur Quelle. Abgeleitete Daten bleiben markiert, um Verwechslungen zu vermeiden.", seasons: "sichtbare Saisons", spotlight: "Hervorgehobene Route", spotlightBody: "Das Kalender-Erlebnis kombiniert Agenda, Routendetails, Wetter und direkte Verbindungen zu Galerie und Archiv.", openHighlights: "Highlights öffnen", yearsLabel: "Rekonstruierte Jahre" },
  ru: { eyebrow: "Публичный календарь клуба", title: "Выезды, события и живой сезон", subtitle: "Публичный календарь клуба объединяет видимые сезоны, восстановленные годы и сравнение погоды точки старта и финиша для каждого выезда.", open2026: "Открыть 2026", weather: "Погода старта / финиша", recovered: "восстановленных событий", pending: "ещё впереди с сегодняшнего дня", viewCalendar: "Открыть календарь", coverageTitle: "Текущее покрытие", coverageBody: "Включает", coverageBody2: "публичные выезды и мероприятия из исходного календаря, названия из архива клуба и даты, восстановленные по фотографиям, когда старый календарь отдавал ошибку.", coverageNote: "Даты, подтверждённые оригинальным сайтом, сохраняют ссылку на источник. Восстановленные даты помечены, чтобы избежать путаницы.", seasons: "видимых сезонов", spotlight: "Главный маршрут", spotlightBody: "Календарь объединяет афишу, детали маршрута, погоду и прямые связи с галереей и архивом.", openHighlights: "Открыть главное", yearsLabel: "Восстановленные годы" },
};
