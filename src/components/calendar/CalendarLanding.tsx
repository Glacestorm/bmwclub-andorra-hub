...
export const CalendarLanding = () => {
  ...
  const recoveredYears = calendarYears.length;
  const nextYearEvents = getEventsByYear(2026);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid gap-8 lg:grid-cols-[1.15fr_0.85fr] items-stretch">
            <div className="glass-dark rounded-[2rem] p-8 md:p-10 text-white relative overflow-hidden shadow-elegant">
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="rounded-full border border-white/15 bg-white/8 px-4 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-white/80">{clubEvents.length} {t.recovered}</span>
                </div>
                <div>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/8 p-4">
                    ...
                    <p className="mt-2 text-3xl font-bold">{calendarYears.length}</p>
                  </div>
                </div>
                <div className="flex flex-wrap items-center gap-3">
            ...
            <Card className="premium-card rounded-[2rem] border-0 p-7 md:p-8 shadow-elegant">
              ...
              <h2 className="mt-4 text-3xl font-bold text-balance">2026 · {yearLabels[2026]}</h2>
        ...
        <div className="container mx-auto px-4">
                ...
                <Card key={year} className="premium-card rounded-[1.75rem] border-0 p-6 space-y-5 shadow-sm transition-base hover:-translate-y-1 hover:shadow-elegant">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h2 className="mt-2 text-2xl font-bold text-balance">{yearLabels[year]}</h2>
                    </div>
                    <span className="stat-pill">{events.length}</span>
                  </div>
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <p>{events.length} {t.recovered}</p>
          ...
          <div className="max-w-5xl mx-auto mt-10">
            <Card className="premium-card rounded-[2rem] border-0 p-6 md:p-8 shadow-elegant">
              ...
              <p className="mt-3 text-muted-foreground">{t.coverageBody} {clubEvents.length} {t.coverageBody2}</p>
