...
export const featuredEventMeta: FeaturedEventMeta[] = [
  ...
  },
  {
    ...
    summary: {
      ca: "El viatge al Museu BMW reforça el relat del club amb marca, territori i experiència compartida.",
      es: "El viaje al Museo BMW refuerza el relato del club con marca, territorio y experiencia compartida.",
      fr: "Le voyage au Musée BMW renforce le récit du club autour de la marque, du territoire et de l'expérience partagée.",
      en: "The trip to the BMW Museum strengthens the club story around the brand, the territory and the shared experience.",
      pt: "A viagem ao Museu BMW reforça a narrativa do clube em torno da marca, do território e da experiência partilhada.",
      de: "Die Reise zum BMW Museum stärkt die Club-Erzählung rund um Marke, Region und gemeinsames Erlebnis.",
      ru: "Поездка в музей BMW усиливает историю клуба вокруг бренда, территории и общего опыта.",
    },
